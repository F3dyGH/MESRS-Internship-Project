 ...
 */
final class Version20210728154443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD about LONGTEXT DEFAULT NULL');
    }
