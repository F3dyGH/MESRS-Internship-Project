 ...
 */
final class Version20210728140627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD image VARCHAR(255) NOT NULL, ADD description VARCHAR(255) NOT NULL');
    }
