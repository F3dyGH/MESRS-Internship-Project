...
// ///////////////////////////////////////////////
    fancyBox:function(){
      if($('[data-fancybox]').exists()){
        loadScript($assetsPath + '/fancybox-v3.5.7/dist/jquery.fancybox.min.js', function(){
...
// ///////////////////////////////////////////////
    SlickCarousel:function(){
        if($('.slick-carousel').exists()){
          loadScript($assetsPath + '/slick-1.8.1/slick/slick.min.js', function(){
...
// ///////////////////////////////////////////////
    owlCarousel:function(){
        ...
        loadScript($assetsPath + '/OwlCarousel2-2.3.4/dist/owl.carousel.min.js', function(){
